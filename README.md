...
| ---------------------- |------| -----------| -------------- | ------------------ |
| Raspberry Pi 4 Model B | 4GB  | 800GB SSD  |  Master Node   | Ubuntu 20.04.2 LTS |
| Raspberry Pi 4 Model B | 4GB  | 120GB SSD  |  Master Node   | Ubuntu 20.04.2 LTS |
| Raspberry Pi 4 Model B | 4GB  | 120GB SSD  |  Master Node   | Ubuntu 20.04.2 LTS |
| VM Node                | 8GB  | 1TB NVMe   |  Worker Node   | Ubuntu 20.04.2 LTS |
| VM Node                | 8GB  | 1TB NVMe   |  Worker Node   | Ubuntu 20.04.2 LTS |
| VM Node                | 8GB  | 1TB NVMe   |  Worker Node   | Ubuntu 20.04.2 LTS |
